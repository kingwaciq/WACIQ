...
def show_waciq():
    ...
    for line in waciq_art:
        ...
        time.sleep(0.05)  # ورو ورو چاپول
    
    # ځلا (blink) افکت
    for _ in range(3):
        print("\033[1;93m".center(cols) + "WACIQ".center(cols) + "\033[0m")
        time.sleep(0.3)
        print(" ".center(cols))
        time.sleep(0.3)
...
if __name__ == "__main__":
    os.system('clear')
    lightning_effect(duration=3, width=60)  # تالندی
    show_waciq()  # لوی WACIQ ښکاره کول 
